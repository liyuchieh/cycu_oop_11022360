...
def plot_bus_route_with_marker(csv_data, geojson_path, output_image="Bus_Route_Map.jpg", marker_image_path=None):
    """
    根據 CSV 資料繪製公車路線圖，並在「進站中」的點位置放置圖片標記。
    ...
    try:
        ...
        # 篩選「進站中」的資料
        in_station_data = csv_data[csv_data['公車到達時間'] == '進站中']
        
        # 如果有「進站中」的資料，添加標記圖片
        if not in_station_data.empty and marker_image_path is not None:
            for _, row in in_station_data.iterrows():
...
if __name__ == "__main__":
    try:
        ...
        if csv_data is not None:
            ...
            # 指定標記圖片的路徑
            marker_image_path = "C:\\Users\\User\\Desktop\\cycu_oop_11022360\\20250429\\bus.png"
